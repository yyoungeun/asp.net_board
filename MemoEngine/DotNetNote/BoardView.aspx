    ...
    <table style="width: 700px; margin-left: auto; margin-right:auto;">
        <tbody>
            <tr style="color:white; background-color:#46698c;">
                ...
                <td colspan="3">
                    <asp:Label ID="lblTitle" Font-Bold="True" Fonr-Size="18px" Width="100%" runat="server"></asp:Label>
                </td>
            </tr>
            ...
            <tr style="background-color: #efefef;">
                ...
                <td class="text-left">Homepage : </td>
                <td>

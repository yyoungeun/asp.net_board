...
namespace MemoEngine.DotNetNote
{
    public partial class BoardList : System.Web.UI.Page
    {
        ...
        //[참고] 이러한 공통 속성들은 Base클래스에 모안 넣고 상속해줘도 좋음
        ...
        {
            //검색 모드 결정
            SearchMode = (!string.IsNullOrEmpty(Request.QueryString["StringField"]) && !string.IsNullOrEmpty(Request.QueryString["SearchQuery"]));
            if (SearchMode)
            {

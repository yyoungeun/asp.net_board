...
<%@ Register Src ="~/DotNetNote/Controls/AdvancedPagingSingleWithBootstrap.ascx" TagPrefix= "uc1" TagName="AdvancedPagingSingleWithBootstrap" %>
        ...
        <tr>
            <td>
                ...
                <asp:GridView ID="ctlBoardList" runat="server" AutoGenerateColumns="false" DataKeyNames="Id" 
                    CssClass="table talbe-bordered table-hover table-condensed table-scriped table-responsive">
                    <Columns>

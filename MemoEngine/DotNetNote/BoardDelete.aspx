<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoardDelete.aspx.cs" Inherits="MemoEngine.DotNetNote.BoardDelete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
        ...
        <asp:Button ID="btnDelete" runat="server" Width="100px" CssClass="btn btn-danger" Style="display: inline-block;" Text="지우기" OnClick="btnDelete_Click" ></asp:Button>

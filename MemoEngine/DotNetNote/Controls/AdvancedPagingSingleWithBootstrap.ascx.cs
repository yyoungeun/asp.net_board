...
namespace MemoEngine.DotNetNote.Controls
{
    ...
    {
        //공통 속성: 검색 모드 : 검색모드이면true, 그렇지 않으면 false.
        public bool SearchMode { get; set; } = false; //일반모드, 검색모드
        ...
        /// <summary>
        /// 총 몇개의 페이지가 만들어지는지 : 총 레코드 수 / 10(한 페이지에서 보여줄 수)
        /// </summary>
        /// 
        [Category("페이징처리")]
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ++PageIndex; //코드: 0, 1, 2 인덱스로 사용, UI: 1, 2, 3페이지로 사용
            int i = 0;
            ...
            if(PageIndex > 10)
            {
                ...
                if (SearchMode)
                {
                    strPage += "<li><a href=\"" + Request.ServerVariables["SCRIPT_NAME"]
                        ...
                        + "?Page="
                        + Convert.ToString(((PageIndex - 1) / (int)10), 10) //진법 변환

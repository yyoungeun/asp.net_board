    ...
    <ItemTemplate>
        <tr style="border-bottom: 1px dotted silver;">
            ...
            <td style="width: 10px; text-align: center;">
                <a href='BoardCommentDelete.aspx?BoardId=<%= Request["Id"] %>&Id=<%# Eval("Id") %>' title="댓글 삭제">
...
<table style="width: 500px; margin-left: auto;">
    <tr>
        ...
        <td style="width: 128px; text-align:right;">
            <asp:Button ID="btnWriteComment" runat="server" Text="의견 남기기" Width="96px" CssClass="form-control btn btn-primary" Style="display:inline-block;" OnClick="btnWriteComment_Click" />
        </td>
    </tr>
    <tr>

...
<div style="text-align:center;">
    ...
    <asp:Button ID="btnSearch" runat="server" Text="검색" CssClass="form-control" Width="100px" Style="display:inline-block;" OnClick="btnSearch_Click"></asp:Button>
</div>
<br />
<% if (!string.IsNullOrEmpty(Request.QueryString["SearchField"]) && !String.IsNullOrEmpty(Request.QueryString["StringQuery"])) { %>
<div style="text-align:center;">

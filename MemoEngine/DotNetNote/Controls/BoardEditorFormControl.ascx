...
<table style="width:600px; border-collapse: collapse; padding: 5px; margin-left:auto; margin-right:auto;">
    ...
    <tr>
        <td class="BoardWriterFormTableLeftStyle">
    ...
    <tr>
        ...
        <td style="width:500px;">
            ...
            <asp:RequiredFieldValidator ID="valName" runat="server" ErroreMessage="* 이름을 작성해주세요" ControlToValidate="txtName" SetFocusOnError="true"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td style="text-align:right;">Email</td>
        <td>
            <asp:TextBox ID="txtEmail" runat="server" MaxLength="80" Width="280px" CssClass="form-control" style ="display:inline-block;"></asp:TextBox>
            <span style="color:#aaaaaa; font-style:italic">(Optional)</span>
            <asp:RegularExpressionValidator ID="valEmail" runat="server" ErrorMessage="* 메일 형식이 올바르지 않습니다." ControlToValidate="txtEmail" 
                Display="None" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" SetFocusOnError="true"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <span style="color:#aaaaaa; font-style:italic;">(Optional)</span>
            <asp:RegularExpressionValidator ID="valHomepage" runat="server" ErrorMessage = "홈페이지를 정확히 작성해주세요." ControlToValidate="txtHomepage" Display="None" ValidationExpression="http://([\w-]+.)+[\w-]+(/[\w-./?%&amp;=])?" SetFocusOnError="true"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:CheckBox ID="chkUpload" runat="server" CssClass="check-inline" Text="이 체크박스를 선택하면 업로드 화면이 나타납니다." 
                AutoPostBack="true" OnCheckedChanged="chkUpload_CheckChanged" ></asp:CheckBox>
            <span style="color:#aaaaaa; font-style:italic">(Optional)</span>
            <br />
